        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
            <div class="p-2 sm:p-6">
                <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-2">
                    <h2 class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                    ...
                    <div class="relative w-full sm:w-auto">
                        <input type="text" 
                               ...
                               class="w-full sm:w-64 pl-10 pr-4 py-2 border rounded-lg border-gray-600 bg-black text-black placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
